...
These are tested behaviors, not aspirations (see `tests/run_tests.py`, 29 scenarios):
...
29 end-to-end scenarios against an in-process mock router — no network, no API keys:
